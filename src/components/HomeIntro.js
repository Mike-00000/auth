...
function HomeIntro() {
    return (
        ...
        <img src="/imgorg.avif" alt="organization_image" style={{ maxWidth: '100%', height: 'auto' }} />
        <div style={{ 
          position: 'absolute', 
          top: 0, 
          left: 0, 
        ...
        <div className="homeintro" style={{ position: 'absolute', top: '20%', left: '50%', transform: 'translate(-50%, -50%)', color: '#d3c7ab' }}>
